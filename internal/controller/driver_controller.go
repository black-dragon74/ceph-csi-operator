...
func (r *DriverReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	driverDefaultsPredicate := predicate.Funcs{
		CreateFunc: func(e event.CreateEvent) bool {
			opConf, ok := e.Object.(*csiv1.OperatorConfig)
			return ok && opConf.Spec.DriverSpecDefaults != nil
		},
		UpdateFunc: func(e event.UpdateEvent) bool {
			oldConf, oldOk := e.ObjectOld.(*csiv1.OperatorConfig)
			newConf, newOk := e.ObjectNew.(*csiv1.OperatorConfig)
			return !oldOk || !newOk ||
...
func (r *driverReconcile) reconcileNodePluginDeamonSetForCsiAddons() error {
	...
	daemonSet.Name = r.generateName("csi-addons-nodeplugin")
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					...
					Containers: utils.Call(func() []corev1.Container {
						...
						// Liveness Sidecar Container
						if r.isRdbDriver() && ptr.Deref(r.driver.Spec.DeployCsiAddons, false) && r.driver.Spec.Liveness != nil {
							containers = append(containers, corev1.Container{
								Name:            "liveness-prometheus",
								Image:           r.images["plugin"],
								ImagePullPolicy: imagePullPolicy,
...
func getControllerPluginPodAffinity(
	pluginSpec *csiv1.ControllerPluginSpec,
	selector *metav1.LabelSelector,
) *corev1.Affinity {
...
func mergeDriverSpecs(dest, src *csiv1.DriverSpec) {
